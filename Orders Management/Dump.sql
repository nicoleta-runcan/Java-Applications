...
CREATE TABLE `ordert` (
  ...
  CONSTRAINT `clientName_fk` FOREIGN KEY (`clientName`) REFERENCES `client` (`clientName`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stock` (
  ...
  CONSTRAINT `productName_fk` FOREIGN KEY (`productName`) REFERENCES `product` (`productName`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-04-15 18:45:03
